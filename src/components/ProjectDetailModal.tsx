...
const ProjectDetailModal: React.FC<Props> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-md bg-black/50 px-4">
      <div className="relative w-full max-w-4xl bg-white dark:bg-slate-800 rounded-xl shadow-2xl overflow-hidden animate-fade-in">
        <button
          onClick={onClose}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6">
          <div className="flex justify-center items-center">
            <img src={image} alt={title} className="w-full h-auto max-h-80 object-contain" />
          </div>
