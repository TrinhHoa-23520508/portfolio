            ...
            <div
                ...
                style={{
                    background: isHovered
                        ? `radial-gradient(600px circle at ${mousePosition.x}px ${mousePosition.y}px, rgba(59, 130, 246, 0.15), transparent 40%), linear-gradient(135deg, ${isDarkMode ? "#1e293b 0%, #0f172a 100%" : "#ffffff 0%, #f8fafc 100%"
                        })`
                        : `linear-gradient(135deg, ${isDarkMode ? "#1e293b 0%, #0f172a 100%" : "#ffffff 0%, #f8fafc 100%"
                        })`,
                }}
            >
                {/* Animated Border */}
                <div
                    ...
                    style={{
                        ...
                        background: `radial-gradient(600px circle at ${mousePosition.x}px ${mousePosition.y}px, ${isDarkMode ? "rgba(59, 130, 246, 0.8)" : "rgba(59, 130, 246, 0.6)"
                            }, transparent 40%)`,
                        padding: "2px",
                ...
                <div
                    ...
                    style={{
                        ...
                        background: `radial-gradient(300px circle at ${mousePosition.x}px ${mousePosition.y}px, ${isDarkMode ? "rgba(168, 85, 247, 0.4)" : "rgba(168, 85, 247, 0.2)"
                            }, transparent 40%)`,
                    }}
                />
                ...
                <div className="relative bg-gray-50 dark:bg-slate-700/50 p-6 flex justify-center">
                    ...
                    <div
                        ...
                        style={{
                            ...
                            background: `radial-gradient(200px circle at ${mousePosition.x}px ${mousePosition.y}px, ${isDarkMode ? "rgba(34, 197, 94, 0.3)" : "rgba(34, 197, 94, 0.2)"
                                }, transparent 60%)`,
                        }}
                    />
                </div>
                ...
                <div className="relative px-6 py-4">
                    ...
                    <div
                        ...
                        style={{
                            ...
                            background: `radial-gradient(250px circle at ${mousePosition.x}px ${mousePosition.y - 200}px, ${isDarkMode ? "rgba(236, 72, 153, 0.3)" : "rgba(236, 72, 153, 0.15)"
                                }, transparent 60%)`,
                        }}
                    />
                </div>
